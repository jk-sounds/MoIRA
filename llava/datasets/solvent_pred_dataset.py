...
def construct_instruct_question(product:str):
    ...
    """
    question_pools = [
        'Can you suggest some possible solvents that could have been used in the following chemical reaction?',
        'Give some possible solvents that could have been used in the following chemical reaction.',
        'Please propose potential solvents that might have been utilized in the provided chemical reaction.',
        'Please provide possible solvents based on the following chemical reaction.',
    ]
...
class SolventPredSupervisedGraphDataset(Dataset):
    """Dataset for Solvent Prediction"""
    add_selfies = True
    def __init__(self, 
                 data_path: str,
        ...
        super(SolventPredSupervisedGraphDataset, self).__init__()
