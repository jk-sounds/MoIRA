...
def construct_instruct_question(product:str):
    ...
    """
    question_pools = [
        'Can you suggest some possible catalysts that could have been used in the following chemical reaction?',
        'Give some possible catalysts that could have been used in the following chemical reaction.',
        'Please propose potential catalysts that might have been utilized in the provided chemical reaction.',
        'Please provide possible catalysts based on the following chemical reaction.',
    ]
...
class CatalystPredSupervisedGraphDataset(Dataset):
    """Dataset for Catalyst Prediction"""
    add_selfies = True
    def __init__(self, 
                 data_path: str,
        ...
        super(CatalystPredSupervisedGraphDataset, self).__init__()
